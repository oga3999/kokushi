...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" xml:lang="ja" lang="ja" xmlns:og="http://ogp.me/ns#" xmlns:fb="http://www.facebook.com/2008/fbml" itemscope="itemscope" itemtype="http://schema.org/">
    <head>
        ...
        <title>理学療法士国家試験・作業療法士　国家試験対策 WEBで合格！</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="keywords" content="理学療法士,理学療法士　国家試験,作業療法士　国家試験,作業療法士,理学療法士　国家試験　塾,PT　国家試験,OT　国家試験" />
        <meta name="description" content="理学療法士　国家試験・作業療法士　国家試験のWEB演習問題サイトです。過去問を無料公開中！毎日の積み重ねで目指せ国試合格！" />
    ...
    <body id="home" class="col2r">
        ...
        <div id="container">
            ...
            <!--        <div id="header-title">-->
            <!--            <p class="header-logo"><a href="./">理学療法士・作業療法士 国家試験対策 WEBで合格！</a></p>-->
            <!--            <h1>理学療法士　国家試験・作業療法士　国家試験のWEB演習問題サイト。毎日の積み重ねで目指せ合格！</h1>-->
            <!--        </div>-->
...
<!--                                                                        ↓⑭<br/>を追加-->
          <a class="navbar-brand phone-brand" href="/">PT・OT WEBで合格</a>
<!--                                                                        ↑⑭<br/>を追加-->
...
<!--<div class="nav-jam"></div>-->
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-4">理学療法士・作業療法士　国家試験対策</h1>
    <p class="lead">ちょっとした時間にちょっとずつ。続けていけば、気付いたら解けるようになる。さあ、頑張ろう。</p>
  </div>
</div>
<!--↑⑦新しいグローバルナビを追加-->
            <!--▲グローバルナビ-->
                ...
                <!--↑⑩col-md-8をmain-contentやtitle_strageを囲うように追加-->
                    ...
                    <div id="main-and-sub">
                        ...
                        <div id="main-contents">
                            ...
                            <p class="description"><span class="top-color">ログイン不要</span>だから、ちょっとした時間に勉強できる。<br/><span class="top-color">たった4ステップ</span>を繰り返すだけ。さあ、今すぐ始めよう。</p>
                            <div class="row top-row">
                              <div class="top-number col-6 col-md-3 col-ms-3"><p><span class="number">STEP1.</span><br/>　科目を選ぶ</p></div>
                              <div class="top-number col-6 col-md-3 col-ms-3"><p><span class="number">STEP2.</span><br/>　問題を選ぶ</p></div>
                              <div class="top-number col-6 col-md-3 col-ms-3"><p><span class="number">STEP3.</span><br/>　問題を解く</p></div>
                              <div class="top-number col-6 col-md-3 col-ms-3"><p><span class="number">STEP4.</span><br/>　解答を見る</p></div>
                            </div>

                             <h2>PT/OT共通問題</h2>
                            <div class="row question-box">
                              <div class="col-md-3 col-6">
                              <a class=" btn btn-outline-secondary top-btn btn1" href="item/item01/" role="button">解剖学</a>
                              </div>
                              <div class="col-md-3 col-6">
                              <a class=" btn btn-outline-secondary top-btn btn1" href="item/item02/" role="button">生理学</a>
                              </div>
                              <div class="col-md-3 col-6">
                              <a class=" btn btn-outline-secondary top-btn btn1" href="item/item03/" role="button">運動学</a>
                              </div>

                              <div class="col-md-3 col-6">
                              <a class=" btn btn-outline-secondary top-btn btn1" href="item/item04/" role="button">病理学</a>
                              </div>

                              <div class="col-md-3 col-6">
                              <a class=" btn btn-outline-secondary top-btn btn2" href="item/item05/" role="button">内科学</a>
                              </div>

                              <div class="col-md-3 col-6">
                              <a class=" btn btn-outline-secondary top-btn btn2" href="item/item06/" role="button">神経内科学</a>
                              </div>

                              <div class="col-md-3 col-6">
                              <a class=" btn btn-outline-secondary top-btn btn2" href="item/item07/" role="button">整形外科学</a>
                              </div>

                              <div class="col-md-3 col-6 ">
                              <a class=" btn btn-outline-secondary top-btn btn2" href="item/item08/" role="button">人間発達学</a>
                              </div>

                              <div class="col-md-3 col-6">
                              <a class=" btn btn-outline-secondary top-btn btn3" href="item/item09/" role="button">リハ概論・医学</a>
                              </div>

                              <div class="col-md-3 col-6">
                              <a class=" btn btn-outline-secondary top-btn btn3" href="item/item10/" role="button">精神医学</a>
                              </div>

                              <div class="col-md-3 col-6">
                              <a class=" btn btn-outline-secondary top-btn btn3" href="item/item11/" role="button">心理学</a>
                              </div>
                            ...
                            <div class="row question-box">
                              ...
                              <div class="col-md-3 col-6">
                                <a class="btn btn-outline-secondary top-btn btn1" href="item/item13/" role="button">臨床運動学</a>
                              </div>
                              <div class="col-md-3 col-6">
                                <a class="btn btn-outline-secondary top-btn btn1" href="item/item14/" role="button">ADL</a>
                              </div>
                              <div class="col-md-3 col-6">
                                <a class="btn btn-outline-secondary top-btn btn1" href="item/item15/" role="button">義肢装具学</a>
                              </div>
                              <div class="col-md-3 col-6">
                                <a class="btn btn-outline-secondary top-btn btn2" href="item/item16/" role="button">物理療法学</a>
                              </div>
                              <div class="col-md-3 col-6">
                                <a class="btn btn-outline-secondary top-btn btn2" href="item/item17/" role="button">法律・その他</a>
                              </div>
                              <div class="col-md-3 col-6">
                            ...
                            <!--<a href="http://comedi.jp/" target="_blank"><img class="big-photo" src="images/comedi2.png" alt="在宅医療・在宅介護のメディアサイト CoMedi【コメディ】"  /></a><br />-->
                            <!--<ul>-->
                            <!--    <li><a href="http://comedi.jp/" target="_blank">在宅医療・在宅介護のメディアサイト CoMedi【コメディ】</a>は、在宅医療・介護の現場を明るく、楽しくお届けするメディアサイトです。<br />-->
                            <!--        主に地域で活躍するコメディカル職と何かしらの障がいを持った当事者らが、お役立ち情報を発信しています。</li>-->
                            <!--</ul>-->
                            <!--/conts-->
                            <!--<h2>地域医療現場見学会を開催します。</h2>
                            <a href="http://k-qol.com/%E3%80%90%E7%AC%AC%E4%BA%8C%E5%BC%BE%E3%80%91%E5%9C%B0%E5%9F%9F%E5%8C%BB%E7%99%82%E7%8F%BE%E5%A0%B4%E8%A6%8B%E5%AD%A6%E4%BC%9A%E3%82%92%E9%96%8B%E5%82%AC%E3%81%97%E3%81%BE%E3%81%99%E3%80%82/" target="_blank"><img src="images/genba_kengaku_banner_wave2.png" alt="【第二弾】地域医療現場見学会を開催します" /></a><br />
                            <a class="study-series" href="http://k-qol.com/%E3%80%90%E7%AC%AC%E4%BA%8C%E5%BC%BE%E3%80%91%E5%9C%B0%E5%9F%9F%E5%8C%BB%E7%99%82%E7%8F%BE%E5%A0%B4%E8%A6%8B%E5%AD%A6%E4%BC%9A%E3%82%92%E9%96%8B%E5%82%AC%E3%81%97%E3%81%BE%E3%81%99%E3%80%82/" target="_blank">これが今の地域医療-福祉現場です！</a>
                            <ul>
                                <li><a href="http://k-qol.com/" target="_blank">金沢QOL支援センター</a>は、ご利用者様の生活を包括して支援し、<br />
                                    真のQOL向上を目指しています。 その取り組みを地域や、<br />
                                    病院で働く医療職の皆様に知っていただき、すべての人が地域で安心して暮らせる社会の形成に少しでも役に立てればと考えています。<br />
                                ぜひ、お気軽にお越しください！</li>
                            </ul><!--/conts-->
                            <!--conts-->
                            <!--<h2>音声で学ぶシリーズ</h2>-->
                            <!--<a href="https://www.dlmarket.jp/products/detail/476576" target="_blank"><img class="big-photo" src="images/onsei.png" alt="onsei" width="503" height="208" /></a><br />-->
                    ...
                    <!--        <div class="contents">-->
                    <!--            <h3>オリジナル教材</h3>-->
                    <!--            <p class="profile-img"><a href="https://www.dlmarket.jp/products/detail/476576" target="_blank"><img src="images/pack.jpg" width="162" height="162" alt="音声商材パック画像" /></a></p>-->
                    <!--            <div class="profile-txt">-->
                    <!--                <p>音声で学ぶ、解剖学・生理学・運動学の3つをひとつのパックにした商品です。</p>-->
                    <!--                <a href="https://plus.google.com/114202562943195504817" rel="publisher" target="_blank">当サイトのGoogle+はこちら！</a>-->
                    <!--            </div>-->
                    <!--        </div>-->
                            ...
                            <!--<div class="contents">-->
                            <!--    <h3>関連サイト</h3>-->
                            <!--    <a href="http://comedi.jp/" target="_blank"><img src="images/comedi.png"></a>-->
...
<!--▲フッターメニュー-->
            ...
            <!--コピーライト-->
            <div class="copyright">
                <p><small>Copyright (C) 2014 理学療法士　国家試験・作業療法士　国家試験対策 WEBで合格！<span>All Rights Reserved.</span></small></p>
            </div>
            <!--/コピーライト-->
